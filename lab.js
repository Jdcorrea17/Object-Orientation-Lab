...
// let apprance = carDetails.color
// let carType = carDetails.make
// let version = carDetails.model
// let dateMade = carDetails.year

let {color: apprance, make: carType, model: version, year: dateMade} = carDetails
...
function ingredients(nutrients){
  const{carbs, fat, protein} = nutrients
  Array = []
  Array.push(nutrients)
  return Array
}
...
let cat1 = new Cat('Garfield', 20, 'Orange')
...
let harry = new Wizard('harry', 24, 'Arbra kadabra')
harry.greeting()
